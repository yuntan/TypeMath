...
import {ControlKey, knowKey, knowControlKey} from './keyboard';
import {Token, TokenSeq, Symbol, Num, Macro, Structure, Matrix, Formula, FontStyle, StructType, BigOpr, Accent} from './formula';
import {Decoration, StrokeStyle, Diagram, LabelPosotion, Arrow} from './diagram';
import * as latex from './latex';
import {LaTeXASTType, LaTeXAST, LaTeXReader} from './latexReader';
import * as unicode from './unicode';
import {Point, GlyphFactory} from './glyph';
		...
		switch (key)
		{
			...
			case ControlKey.Enter:
				...
				if (this.activeField instanceof Formula)
				{
					...
					{
						var res = calc(f.tokens.slice(0, this.activeIndex - 1));
